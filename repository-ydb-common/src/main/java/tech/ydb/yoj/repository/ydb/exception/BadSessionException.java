...
public class BadSessionException extends YdbUnconditionallyRetryableException {
    public BadSessionException(Enum<?> statusCode, Object request, Object response) {
        this(statusCode, RetryPolicy.retryImmediately(), request, response);
    }

    public BadSessionException(Enum<?> statusCode, RetryPolicy retryPolicy, Object request, Object response) {
        super("Bad session", statusCode, request, response, retryPolicy);
    }
}
