...
public final class UnconventionalFieldNamesFields {
    ...
    public static final String FIELD_IN__UPPER_CAMEL_CASE_INTEGRAL = "FieldIn_UpperCamelCase";
    ...
    public static final String __FIELD_STARTED_WITH_UNDER_SCORE_INTEGRAL = "_FieldStartedWithUnderScore";
