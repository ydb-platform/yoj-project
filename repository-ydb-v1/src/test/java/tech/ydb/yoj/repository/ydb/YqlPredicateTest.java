...
public class YqlPredicateTest {
    ...
    public void fluent_builders_are_left_associative() {
        ...
        assertThat(pred.paramList()).containsExactly(
                YqlPredicateParam.of("workers", 0L, false, ComplexField.TUPLE, CollectionKind.SINGLE),
                YqlPredicateParam.of("status", "READY", false, ComplexField.TUPLE, CollectionKind.SINGLE),
