...
import tech.ydb.yoj.repository.ydb.statement.Statement.QueryType;
...
public class QueriesMergerTest {
    ...
    public void mergeDeleteInsertQueries() {
        ...
        assertThat(result).hasSize(1);
        assertThat(result.get(0).getStatement().getQueryType()).isEqualTo(QueryType.UPSERT);
    }
    ...
    public void mergeInsertDeleteQueries() {
        ...
        assertThat(result).hasSize(2);
        assertThat(result.get(0).getStatement().getQueryType()).isEqualTo(QueryType.INSERT);
        assertThat(result.get(0).getValues()).isEqualTo(Collections.singletonList(p));
        assertThat(result.get(1).getStatement().getQueryType()).isEqualTo(QueryType.DELETE);
    ...
    public void mergeDeleteAllQueries() {
        ...
        assertThat(result).hasSize(1);
        assertThat(result.get(0).getStatement().getQueryType()).isEqualTo(QueryType.DELETE_ALL);
    }
