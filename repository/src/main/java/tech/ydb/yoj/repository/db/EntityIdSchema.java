...
public final class EntityIdSchema<ID extends Entity.Id<?>> extends Schema<ID> implements Comparator<ID> {
     ...
     *                                  <em>E.g.</em>, for a four-column ID {@code (a, b, c, d)}, the {@code cells} map
     *                                  contains only the {@code id_a} and {@code id_c} keys but {@code id_b} is missing
     * @see Range#create(EntityIdSchema, Entity.Id)
     * @see #newRange(Map, Map)
     * @see #newInstance(Map)
     */
    @NonNull
    public Range<ID> newRange(@NonNull Map<String, Object> cells) {
