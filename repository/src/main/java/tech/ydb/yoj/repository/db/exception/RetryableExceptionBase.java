...
/**
 * Common base class for both {@link RetryableException unconditionally retryable}
 * and {@link ConditionallyRetryableException conditionally retryable} database exceptions.
 */
@ExperimentalApi(issue = "https://github.com/ydb-platform/yoj-project/issues/165")
public abstract sealed class RetryableExceptionBase
        extends RepositoryException
        permits RetryableException, ConditionallyRetryableException {
